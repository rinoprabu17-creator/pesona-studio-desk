...
const config: WorkerConfig = {
  ...
  intervalMs: Number(process.env.MOCKUP_WORKER_POLL_INTERVAL_MS || "15000")
};
...
const heartbeat = setInterval(() => {
  log("heartbeat", {
    message: "Placeholder aktif. Render mockup belum diimplementasikan."
  });
}, config.intervalMs);
