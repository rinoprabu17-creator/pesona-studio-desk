...
const result = parseAndReviewSourceFolderFixtureManifestFileCreationDryRunExecutionGateApprovalReviewApprovalGateFixture({
...
const output = {
  ...
  fixture_manifest_file_creation_dry_run_execution_gate_approval_review_approval_gate_cases: result.gates.length,
  reviewed_execution_gate_approval_review_items: result.reviewedExecutionGateApprovalReviewItems,
  approved_for_future_fixture_manifest_file_creation_dry_run_execution_gate_approval_review_approval_count:
    result.approvedForFutureFixtureManifestFileCreationDryRunExecutionGateApprovalReviewApprovalCount,
  ...
  gate_summaries: result.gates.map((gate) => ({
    fixture_manifest_file_creation_dry_run_execution_gate_approval_review_approval_gate_id:
      gate.fixture_manifest_file_creation_dry_run_execution_gate_approval_review_approval_gate_id,
    source_id: gate.source_id,
    source_execution_gate_approval_review_status: gate.source_execution_gate_approval_review_status,
    reviewed_execution_gate_approval_review_items: gate.reviewed_execution_gate_approval_review_items,
    ...
    duplicate_id_findings_count: gate.duplicate_id_findings.length,
    missing_approval_fields_count: Object.values(gate.missing_approval_fields).reduce((total, value) => total + value, 0),
    fixture_manifest_file_creation_dry_run_execution_gate_approval_review_approval_allowed:
  ...
  next_phase: "Phase 2J.34 Real Footage Source Folder Fixture Manifest File Creation Dry-Run Execution Gate Approval Review Follow-up Review"
};

if (
  output.provider !== "fake_content_engine" ||
  output.fixture_manifest_file_creation_dry_run_execution_gate_approval_review_approval_gate_cases < 1 ||
  output.reviewed_execution_gate_approval_review_items < 5 ||
  output.approved_for_future_fixture_manifest_file_creation_dry_run_execution_gate_approval_review_approval_count < 1 ||
  ...
  throw new Error("real_footage_source_fixture_manifest_file_creation_dry_run_execution_gate_approval_review_approval_smoke_failed");
}
