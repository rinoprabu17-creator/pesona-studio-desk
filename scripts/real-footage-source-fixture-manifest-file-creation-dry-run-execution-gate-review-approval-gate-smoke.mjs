...
const result = parseAndReviewSourceFolderFixtureManifestFileCreationDryRunExecutionGateReviewApprovalGateFixture({
...
const output = {
  ...
  fixture_manifest_file_creation_dry_run_execution_gate_review_approval_gate_cases: result.gates.length,
  reviewed_execution_gate_review_items: result.reviewedExecutionGateReviewItems,
  approved_for_future_fixture_manifest_file_creation_dry_run_execution_gate_approval_review_count:
    result.approvedForFutureFixtureManifestFileCreationDryRunExecutionGateApprovalReviewCount,
  ...
  approval_summaries: result.gates.map((gate) => ({
    fixture_manifest_file_creation_dry_run_execution_gate_review_approval_gate_id:
      gate.fixture_manifest_file_creation_dry_run_execution_gate_review_approval_gate_id,
    source_id: gate.source_id,
    source_execution_gate_review_status: gate.source_execution_gate_review_status,
    reviewed_execution_gate_review_items: gate.reviewed_execution_gate_review_items,
    ...
    fixture_manifest_file_creation_dry_run_execution_gate_review_allowed:
      gate.fixture_manifest_file_creation_dry_run_execution_gate_review_allowed,
    ...
    fixture_manifest_execution_review_persisted:
      gate.fixture_manifest_execution_review_persisted,
  ...
  next_phase: "Phase 2J.32 Real Footage Source Folder Fixture Manifest File Creation Dry-Run Execution Gate Approval Review"
};

if (
  output.provider !== "fake_content_engine" ||
  output.fixture_manifest_file_creation_dry_run_execution_gate_review_approval_gate_cases < 1 ||
  output.reviewed_execution_gate_review_items < 5 ||
  output.approved_for_future_fixture_manifest_file_creation_dry_run_execution_gate_approval_review_count < 1 ||
  ...
  throw new Error(
    "real_footage_source_fixture_manifest_file_creation_dry_run_execution_gate_review_approval_gate_smoke_failed"
  );
}
