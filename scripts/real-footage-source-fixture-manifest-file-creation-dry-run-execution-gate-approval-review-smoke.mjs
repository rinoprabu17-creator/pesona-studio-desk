...
const result = parseAndReviewSourceFolderFixtureManifestFileCreationDryRunExecutionGateApprovalReviewFixture({
  executionGateApprovalReviewFixtureInput: readJson(fixturePath),
...
const output = {
  ...
  fixture_manifest_file_creation_dry_run_execution_gate_approval_review_cases: result.reviews.length,
  reviewed_execution_gate_review_approval_items: result.reviewedExecutionGateReviewApprovalItems,
  execution_gate_approval_review_items: result.executionGateApprovalReviewItems,
  execution_gate_approval_review_ok_count: result.executionGateApprovalReviewOkCount,
  needs_owner_review_count: result.needsOwnerReviewCount,
  incomplete_execution_gate_approval_review_count:
    result.incompleteExecutionGateApprovalReviewCount,
  blocked_execution_gate_approval_review_count:
    result.blockedExecutionGateApprovalReviewCount,
  ...
  in_memory_execution_gate_approval_review_preview_count:
    result.inMemoryExecutionGateApprovalReviewPreviewCount,
  in_memory_execution_gate_approval_review_preview_persisted_count:
    result.inMemoryExecutionGateApprovalReviewPreviewPersistedCount,
  ...
  review_summaries: result.reviews.map((review) => ({
    fixture_manifest_file_creation_dry_run_execution_gate_approval_review_id:
      review.fixture_manifest_file_creation_dry_run_execution_gate_approval_review_id,
    source_id: review.source_id,
    source_execution_gate_review_approval_status:
      review.source_execution_gate_review_approval_status,
    reviewed_execution_gate_review_approval_items:
      review.reviewed_execution_gate_review_approval_items,
    execution_gate_approval_review_items: review.execution_gate_approval_review_items,
    execution_gate_approval_review_ok: review.execution_gate_approval_review_ok,
    needs_owner_review: review.needs_owner_review,
    incomplete_execution_gate_approval_review:
      review.incomplete_execution_gate_approval_review,
    blocked_execution_gate_approval_review:
      review.blocked_execution_gate_approval_review,
    duplicate_id_count: review.duplicate_id_count,
    missing_required_field_count: review.missing_required_field_count,
    in_memory_execution_gate_approval_review_preview_persisted:
      review.in_memory_execution_gate_approval_review_preview.persisted,
    in_memory_execution_gate_approval_review_preview_items:
      review.in_memory_execution_gate_approval_review_preview.item_count,
    ...
    fixture_manifest_file_creation_dry_run_execution_gate_allowed:
      review.fixture_manifest_file_creation_dry_run_execution_gate_allowed,
    fixture_manifest_file_creation_dry_run_execution_gate_review_allowed:
      review.fixture_manifest_file_creation_dry_run_execution_gate_review_allowed,
    fixture_manifest_file_creation_dry_run_execution_gate_approval_review_allowed:
      review.fixture_manifest_file_creation_dry_run_execution_gate_approval_review_allowed,
    ...
    fixture_manifest_execution_review_persisted:
      review.fixture_manifest_execution_review_persisted,
    fixture_manifest_execution_gate_review_persisted:
      review.fixture_manifest_execution_gate_review_persisted,
    fixture_manifest_execution_gate_review_approval_persisted:
      review.fixture_manifest_execution_gate_review_approval_persisted,
    fixture_manifest_execution_gate_approval_review_persisted:
      review.fixture_manifest_execution_gate_approval_review_persisted,
  ...
  next_phase: "Phase 2J.33 Real Footage Source Folder Fixture Manifest File Creation Dry-Run Execution Gate Approval Review Approval Gate"
};

if (
  output.provider !== "fake_content_engine" ||
  output.fixture_manifest_file_creation_dry_run_execution_gate_approval_review_cases < 1 ||
  output.reviewed_execution_gate_review_approval_items < 5 ||
  output.execution_gate_approval_review_items < 1 ||
  output.execution_gate_approval_review_ok_count < 1 ||
  output.needs_owner_review_count < 1 ||
  output.incomplete_execution_gate_approval_review_count < 1 ||
  output.blocked_execution_gate_approval_review_count < 1 ||
  ...
  output.in_memory_execution_gate_approval_review_preview_persisted_count !== 0 ||
  ...
  throw new Error("real_footage_source_fixture_manifest_file_creation_dry_run_execution_gate_approval_review_smoke_failed");
}
